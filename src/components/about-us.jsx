          ...
          <div className="max-w-8xl w-full space-y-8">
            <div className="bg-emerald-50 shadow-md rounded-lg p-8">
              <div className="space-y-6">
                ...
                <div>
                  <h4 className=" text-gray-800">About Proficientme</h4>
                  <p className="mt-2 text-gray-600">
                    Welcome to Proficientme, your partner in lifelong learning.
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-600">
                    At Proficientme, we envision a future where education knows
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-600">
                    When you choose Proficientme, you're not just enrolling in a
